...
function getPreproData (rawDataHierarchy,rawData,rawGeoJson,stepTemporal,polarityTemporal){
	...
	let leaf_level_outflow =  kaka(timeWindow, dataset, 0, arraySubIndicators, "", hierarchy);
	let leaf_level_inflow = kaka(timeWindow, dataset, 1, arraySubIndicators, "", hierarchy);
	// console.log(leaf_level_outflow)
...
function kaka(timeWindow, dataset, indexIndicator, subArrayIndicators, filtroDeNose, jerarquiaInstance){
...
function mergingChildrenNuevo (father, children, my_leaf_level){
	...
	// if(father.name==='australia/new zealand'){
	// 	console.log("-----------------------------------------------encontro ausria/new zealand")
	...
	// 		d.components.forEach(c=>{
	// 			console.log(c.name)
	// 			console.log(c.arraray.map(a=>a.value))

	// 		})
	// 		console.log("")
	// 	});
	// 	// console.log(fusion.components)
