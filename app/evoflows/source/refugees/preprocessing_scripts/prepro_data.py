...
inputCsv = "../raw/unhcr_popstats_export_persons_of_concern_all_data_until_2018.csv"
inputTmpCleanCsv = "../raw/tmpClean.csv" #create automatic over the preprocess and delete after finish
outputCsv = "../data.csv"
