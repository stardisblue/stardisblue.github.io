...
function removeOverlapping(data){
	...
	let dataWork = data.filter(d=>d.key!="");
...
function getNewEndArrowAccordingStartArrowInclination(startArrowCenter,endArrowCenter,endArrowLabelWidth, endArrowLabelHeight){
	...
	if(destY<=oriY){
		newDestY = destY - destLabelHeightMiddle;
	}else{
		newDestY = destY + destLabelHeightMiddle;
	}
